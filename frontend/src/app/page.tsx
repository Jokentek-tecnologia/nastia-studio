    ...
    return (
        <main className="h-screen bg-[#050505] text-white flex flex-col font-sans relative overflow-hidden">
            ...
            <div className="flex-1 w-full flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto w-full p-4 py-6">
                    <div className="w-full max-w-6xl mx-auto space-y-6">

                        {mode === 'home' && (
                            <div className="w-full animate-in fade-in slide-in-from-bottom-4 space-y-6 pb-20 max-w-2xl mx-auto">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="bg-[#121214] border border-gray-800 p-4 rounded-2xl flex flex-col justify-between relative overflow-hidden cursor-pointer" onClick={toggleStore}>
                        ...
                        {mode !== 'home' && (
                            <div className="flex w-full bg-gray-900 p-1.5 rounded-2xl border border-gray-800 overflow-x-auto shrink-0 mb-4 max-w-3xl mx-auto">
                        ...
                        {mode === "chat" && (
                            <div className="w-full flex flex-col md:flex-row gap-4 h-[65vh] md:h-[600px] max-w-5xl mx-auto">
                        ...
                        {(mode === "image" || mode === "video") && (
                            <div className="flex flex-col md:flex-row gap-6 w-full h-full max-w-6xl mx-auto items-start">
                                {/* COLUNA ESQUERDA: CONTROLES */}
                                <div className={`flex-1 flex flex-col gap-4 w-full ${resultUrl ? 'md:w-1/2' : 'md:max-w-2xl md:mx-auto'}`}>
                                ...
                                {/* COLUNA DIREITA: RESULTADO (SÓ APARECE SE TIVER) */}
                                {resultUrl && !loading && (
                                    <div className="flex-1 w-full md:w-1/2 bg-[#0f0f10] border border-gray-800 rounded-3xl p-6 shadow-2xl animate-in fade-in slide-in-from-right-4 h-fit">
            ...
            <footer className="w-full py-8 mt-10 border-t border-gray-900 bg-black/80 text-center text-gray-600 text-sm shrink-0">
