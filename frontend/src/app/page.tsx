...
export default function Home() {
    ...
    // FUNÇÃO PARA CLICAR NO BOTÃO EDITAR NO CELULAR (Mostra Alerta)
    const handleMobileEditClick = () => {
        alert("⚠️ Para adicionar textos e elementos gráficos, use o editor no computador.\n\nNo celular, você pode editar pedindo para a IA no chat: 'Edite a imagem para...'");
    };
    ...
    // FECHAR JANELAS SOBREPOSTAS (Item 6)
            ...
            <header className="w-full p-4 border-b border-gray-800 bg-black/50 backdrop-blur-md flex justify-between items-center sticky top-0 z-30">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        ...
                        {showNotifications && (
                            <div className="absolute top-full right-[-50px] sm:right-0 mt-2 w-[85vw] sm:w-80 bg-[#18181b] border border-gray-700 rounded-xl shadow-2xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2">
                            ...
                            <div className="w-full bg-[#0f0f10] border border-gray-800 rounded-3xl p-6 shadow-2xl animate-in fade-in slide-in-from-bottom-4">
                                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        {/* LÓGICA DE EXIBIÇÃO DO EDITOR NO CELULAR (Item 4) */}
                                        {mode === "image" && (
                                            <button
